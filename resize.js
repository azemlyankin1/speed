...
function resize(elem, elemResize) {
  var ie = 0;
var op = 0;
var ff = 0;
...
onload = function () {
  ...
  block = document.querySelector(elem); // Получаем основной блок
  block_r = document.querySelector(elemResize); // Получаем блок для изменения размеров
